...
import 'package:quitsmoke/screens/jurnal_screen.dart';
...
import 'package:quitsmoke/screens/usersWallet.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
            ...
            child: Row(
              ...
              children: [
                ...
                buildCategoryCard(sc, context,
                    color: Colors.grey,
                    icon: Icons.wallet,
                    text: "${langs[lang]["home"]["userwall"]}",
                    id: "settings", onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => UsersWallets()));
                    }),
                SizedBox(
                  width: getProportionateScreenWidth(15),
                ),
          ...
          Container(
            width: 80,
            child: buildCategoryCard(sc, context,
                color: Colors.red,
                icon:  Icons.settings_backup_restore,
                text: "",
                id: "x", onTap: () => showAlertDialog(context)),
          ),
          SizedBox(
            height: getProportionateScreenHeight(5),
          ),
