...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> loadData() async {
    ...
    country = pref.getString("userCountry");
    city = pref.getString("userCity");

    print("user data $name $city $country");
    ...
    controllerName.text = name.toString();
    controllerCountry.text = country.toString();
    controllerCity.text = city.toString();
    setState(() {});
  }
